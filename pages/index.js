  ...
  render() 
  {
    ...
    return (
      <div>
        ...
        <li><a href="#" onClick={this.searchNewsAPI} name="top-headlines?country=ie">Ireland - Main Headlines</a></li>
          <li><a href="#" onClick={this.searchNewsAPI} name="top-headlines?country=ie">UK - Main Headlines</a></li>
          <li><a href="#" onClick={this.searchNewsAPI} name="everything?q=abc-news">ABC News</a></li>
          <li><a href="#" onClick={this.searchNewsAPI} name="everything?q=health">Health News</a></li>
          <li><a href="#" onClick={this.searchNewsAPI} name="everything?q=business">Business News</a></li>
        </ul>
