  ...
  render() 
  {
    ...
    return (
      <div>
        ...
        <li><a href="#" onClick={this.searchNewsAPI} name="everything?q=the-next-web">The Next Web</a></li>
        <li><a href="#" onClick={this.searchNewsAPI} name="everything?q=techradar">TechRadar</a></li>
        </ul>
