    ...
    return (
      <div>
        ...
        <ul className="newsMenu">
         <li><a href="#" onClick={this.searchNewsAPI} name="everything?q=the-irish-times">The Irish Times</a></li>
         <li><a href="#" onClick={this.searchNewsAPI} name="everything?q=daily-mail">The Daily Mail</a></li>
         <li><a href="#" onClick={this.searchNewsAPI} name="everything?q=financial-times">The Financial Times</a></li>
         <li><a href="#" onClick={this.searchNewsAPI} name="everything?q=the-telegraph">The Telegraph</a></li>
        </ul>
