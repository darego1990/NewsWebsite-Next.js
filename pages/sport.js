  ...
  render() 
  {
    ...
    return (
      <div>
        ...
        <li><a href="#" onClick={this.searchNewsAPI} name="everything?q=bbc-sport">BBC Sport</a></li>
        <li><a href="#" onClick={this.searchNewsAPI} name="everything?q=espn">ESPN</a></li>
        <li><a href="#" onClick={this.searchNewsAPI} name="everything?q=four-four-two">FourFourTwo Sport</a></li>
        <li><a href="#" onClick={this.searchNewsAPI} name="everything?q=talksport">TalkSport</a></li>
        </ul>
